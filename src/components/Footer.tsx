    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">Sarah Chen</h3>
            <p className="text-gray-400 text-sm mb-4">
              Data Analytics Professional specializing in transforming complex data 
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start">
                ...
                <a href="mailto:sarah.chen@dataanalytics.com" className="text-gray-400 hover:text-white transition-colors">
                  sarah.chen@dataanalytics.com
                </a>
              </li>
              <li className="flex items-center">
                ...
                <span className="text-gray-400">24 hours response time</span>
              </li>
            </ul>
          </div>
        </div>
